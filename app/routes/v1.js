...
router.get('/d2/google-search', function (req, res) {

  var searchTerm = req.query.searchTerm;

  res.render('v1/d2/google-search', {
...
router.get('/d2/google-results', function (req, res) {

  // get the answer from the query string (eg. ?over18=false)
  var searchTerm = req.query.searchTerm;
//  process.stdout.write("HAI THERE");

  res.render('v1/d2/google-results', {
    searchTerm: searchTerm
    });
...
router.get('/d2/find-a-service', function (req, res) {
...
//  process.stdout.write("HAI THERE");
  ...
  res.render('v1/d2/find-a-service', {
    condition: condition,
...
router.get('/d2/check-location', function (req, res) {
...
router.get('/d2/show-list-of-services', function (req, res) {
...
router.get('/d2/book-an-appointment-online', function (req, res) {
...
//  process.stdout.write("HAI THERE");
  ...
  res.render('v1/d2/book-an-appointment-online', {
