...
router.get('/check-location', function (req, res) {
  ...
  if (req.query.postcode === '') {
    ...
    res.render('v3/show-list-of-services');
  }
...
router.get('/show-list-of-services', function (req, res) {
  ...
  if (serviceGP == 'true') {
    ...
    var GPData = require('../views/v3/data_files/data_gp_LS.json');
...
//      }
  ...
  if (servicePharmacy == 'true') {
    ...
    var pharmaciesData = require('../views/v3/data_files/data_pharmacies_LS.json');
...
//      }
    ...
    if (serviceSexualHealthClinic == 'true') {
      ...
      var sexualhealthclinicData = require('../views/v3/data_files/data_sexualhealthclinic_LS.json');
...
//  process.stdout.write("HAI THERE");
  ...
  res.render('v3/book-an-appointment-online', {
